...
const CarouselCardHome2 = () => {
  ...
  return (
    <div>
      <h1 className="py-5 text-[25px] font-medium">Smartfonlar</h1>
      <Swiper
        style={{
      ...
      >
        {dataUrl.map((v) => (
          <SwiperSlide key={v.id*2} className="swiper-slide2">
            <div className="w-[250px] bg-white py-2 px-[10px] flex flex-col  justify-between gap-2 rounded-2xl">
              <div
