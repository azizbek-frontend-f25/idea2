...
const CarouselCardHome3 = () => {
  ...
  return (
    <div>
      <h1 className="py-5 text-[25px] font-medium">Katta maishiy texnika</h1>
      <Swiper
        style={{
      ...
      >
        {dataUrl.map((v) => (
          <SwiperSlide key={v.id*2} className="swiper-slide3">
            <div className="w-[250px] bg-white py-2 px-[10px] flex flex-col justify-between gap-1 rounded-2xl">
              <div
              ...
              >
                ...
                <p className="text-start text-sm text-gray-400">
                  Brend:{" "}
                  <span className="text-gray-500 text-sm underline hover:text-[#DD1470] cursor-pointer">
                    {v.brend}
                  </span>
                </p>
              </div>
